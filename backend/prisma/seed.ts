  ...
  const journals = [
    {
      ...
      description:
        'Publishes groundbreaking research on environmental science, climate change mitigation, and sustainability solutions.',
      issn: '2765-9820',
    ...
    },
    {
      ...
      description:
        'Explores cross-cultural communication, global narratives, and sociological perspectives on cultural evolution.',
      issn: '3012-4478',
      publisher: 'Universal Publishers',
      accessType: 'Hybrid',
    ...
    },
    {
      ...
      description:
        'Focuses on translational research and innovations in biomedical devices, imaging, and healthcare technologies.',
      issn: '2134-9987',
      publisher: 'Universal Publishers',
      accessType: 'Open Access',
    ...
    },
    {
      ...
      description:
        'Presents applied research on financial systems, emerging markets, and sustainable economic policy.',
      issn: '1988-6423',
      publisher: 'Universal Publishers',
    ...
    },
    {
      ...
      description:
        'Delivers peer-reviewed insights on information systems design, cybersecurity, and data governance.',
      issn: '2546-3301',
      publisher: 'Universal Publishers',
      accessType: 'Hybrid',
    ...
    },
    {
      ...
      description:
        'Highlights advancements in diagnostics, clinical trials, and evidence-based patient care.',
      issn: '1620-7735',
      publisher: 'Universal Publishers',
      accessType: 'Open Access',
    ...
    },
    {
      ...
      description:
        'Investigates sustainable farming practices, agri-tech innovations, and food security strategies.',
      issn: '2874-1159',
      publisher: 'Universal Publishers',
      accessType: 'Open Access',
    ...
    },
    {
      ...
      description:
        'Offers current research on cognitive science, behavioral psychology, and mental health interventions.',
      issn: '1901-4472',
      publisher: 'Universal Publishers',
      accessType: 'Hybrid',
    ...
    },
    {
      ...
      description:
        'Publishes experimental and theoretical work on novel materials, nanotechnology, and applied physics.',
      issn: '2285-9031',
      publisher: 'Universal Publishers',
      accessType: 'Subscription',
    ...
    },
    {
      ...
      description:
        'Examines pedagogical innovation, digital learning frameworks, and global education policy.',
      issn: '2659-4410',
      publisher: 'Universal Publishers',
      accessType: 'Open Access',
