 ...
 * Run with: npx tsx frontend/src/app/journal-admin/journals/articles-press/__tests__/filterLogic.test.ts
 */
...
function filterArticlesForCards(articles: Article[]): Article[] {
...
function filterCurrentIssueArticles(articles: Article[]): Article[] {
  return articles.filter((article) => {
...
function filterCalendarArticles(
  articles: Article[],
  previewMonth?: string,
  previewYear?: string
): Article[] {
